...
class BasicoPage extends StatelessWidget {
  ...
  Widget _crearImagen(BuildContext context) {
    return Container(
      ...
      child: GestureDetector( // Un widget que detecta gestos, es decir si tocas click te lleva a una page
        onTap: ()=> Navigator.pushNamed(context, 'scroll'), // ontap lo que quiere que haga cuando detecta un gesto
        child: Image(
